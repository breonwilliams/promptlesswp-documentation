...
### Editor Preview
**What it is**: The live preview you see in the center panel of the editor
**Shows**: Real-time updates as you edit
**Purpose**: Immediate feedback while building
**Limitations**: May not show exact theme integration

### Page Preview  
**What it is**: Full page preview in a new browser tab
**Shows**: Exactly how visitors will see your page
**Purpose**: Final check before publishing
**Includes**: Your theme's header, footer, and navigation

### Live Site
**What it is**: Your actual published page on the internet
**Shows**: The final result visitors see
**Purpose**: The real deal - your published content
**Includes**: Full theme integration, SEO, and functionality

## Using the Preview System

### Opening Preview
1. **Click the "Preview" button** in the top toolbar (eye icon)
2. **New browser tab opens** showing your page
3. **Page displays** exactly as visitors will see it
4. **Keep both tabs open** for easy comparison
...
### Canvas Mode
**What it does**: Creates a blank page with no theme elements
**Best for**:
- Landing pages
- Sales pages  
- Event pages
...
**How to enable**:
1. **Go to the WordPress page editor** (not Promptless WP)
2. **Find the "Promptless WP" meta box**
3. **Change Display Mode to "Canvas"**
4. **Update the page**

### Fullwidth Mode (Default)
**What it does**: Shows your sections within your theme's layout
**Best for**:
...
1. **Complete your preview testing** 
2. **Go back to WordPress page editor**
3. **Set page status to "Published"**
4. **Choose visibility** (Public, Private, or Password Protected)
5. **Set publication date** (now or schedule for later)
6. **Click "Publish"**

### Updating Existing Pages
If updating a page that's already live:
1. **Make your changes** in Promptless WP editor
2. **Save your changes** in the editor
3. **Preview to verify** everything looks correct
4. **Go to WordPress page editor**
5. **Click "Update"** to make changes live

### Publishing Workflow
**Recommended steps**:
1. **Build content** in Promptless WP editor
2. **Save frequently** while building
3. **Preview when sections are complete**
...
### Browser Cache
**What it is**: Your browser stores copies of images and files
**Why it matters**: You might not see changes immediately
**Solution**: 
...
### Plugin Caching
**What it is**: Caching plugins store page copies for speed
**Why it matters**: Changes might not appear on live site immediately
**Solution**:
...
### CDN Caching
**What it is**: Content delivery networks cache your site globally
**Why it matters**: Changes may take longer to appear worldwide
**Solution**:
...
**Solutions**:
1. **Check display mode** in WordPress page editor
2. **Clear all caches** and refresh
3. **Save changes** again in editor
...
**Solutions**:
1. **Check for orange/red** section indicators
2. **Fix missing content** or broken media
3. **Test with default theme** temporarily
...
**Solutions**:
1. **Test with mobile device** (not just narrow browser)
